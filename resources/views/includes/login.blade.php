<nav class="navbar navbar-expand-lg nav-default fixed-top bg-white">
    ...
    <div class="collapse navbar-collapse justify-content-between" id="navbarTogglerDemo01">
      <div class="d-flex flex-column w-100">
        ...
        <div class="d-flex justify-content-between align-items-center main-nav">
          ...
          <div>
            <a href="https://membership.saycheers.com/" class="btn btn-danger btn-lgn d-flex" type="submit">MEMBERSHIP</a>
          </div>
        </div>
    </div>
  </div>
